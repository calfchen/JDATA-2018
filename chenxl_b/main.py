...
if __name__=="__main__":
    ...
    if line==online:
        ...
        # predict online
        online_test["preds"] = model_1.predict(online_test[feature]).reshape((online_test.shape[0], 1))
        online_test["day"] = model_2.predict(online_test[feature]).reshape((online_test.shape[0],1))
        ...
        #online_test[['user_id','pred_date']][:50000].to_csv("../out/lgb_6_27_B_submit_1.csv", index=None)
        online_test[['user_id','pred_date','preds']].to_csv("../out/lgb_6_27_B_1.csv", index=None)
